...
// ---------------------------------------------------
// Ana render (sadece Yonetici erisebilir)
// ---------------------------------------------------

export async function renderUsers({ profile }) {
    setPageTitle('Kullanicilar');
    ...
    if (error) {
        showToast('Kullanicilar yuklenemedi: ' + error.message, 'error');
        return;
    }
...
function buildHTML(profiles, currentProfile) {
    const rows = profiles.length
        ...
        : `<tr><td colspan="6" class="px-5 py-10 text-center text-sm text-gray-400">Kullanici bulunamadi.</td></tr>`;
    ...
    return `
        <div class="max-w-5xl mx-auto">
            ...
            <div class="flex items-center justify-between mb-6">
                <div>
                    <h1 class="text-2xl font-bold text-gray-800">Kullanicilar</h1>
                    <p class="text-sm text-gray-500 mt-0.5">${profiles.length} kullanici</p>
                </div>
            </div>
                    ...
                    <table class="w-full text-sm text-left">
                        <thead class="text-xs text-gray-500 uppercase tracking-wider bg-gray-50 border-b border-gray-100">
                            <tr>
                                ...
                                <th class="px-5 py-3 font-medium text-right">Islemler</th>
                            </tr>
                        </thead>
        ...
        <div id="user-modal" class="hidden fixed inset-0 z-50 flex items-center justify-center modal-overlay"
            ...
            <div class="bg-white rounded-2xl shadow-xl w-full max-w-md mx-4">
                <div class="flex items-center justify-between px-6 py-4 border-b border-gray-100">
                    <h3 class="text-lg font-semibold text-gray-800">Kullanici Duzenle</h3>
                    ...
                    <div class="px-6 py-5 space-y-4">
                        ...
                        <div>
                            ...
                            <select name="role"
                                ...
                                <option value="Satis Personeli">Satis Personeli</option>
...
function bindEvents(profile, profiles) {
    ...
    document.querySelector('tbody')?.addEventListener('click', async e => {
        ...
        if (action === 'toggle-active') {
            ...
            showToast(isActive ? 'Kullanici pasife alindi.' : 'Kullanici aktife alindi.', 'success');
